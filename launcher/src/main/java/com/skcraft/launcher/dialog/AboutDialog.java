...
public class AboutDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        container.add(new JLabel("<html>Deadman Gamers Minecraft Launcher"), "wrap, gapbottom unrel");
        container.add(new JLabel("<html>A Custom Launcher for Deadman Gamers."), "wrap, gapbottom unrel");
        container.add(new JLabel("<html>Built on SKCraft Launcher."), "wrap, gapbottom unrel");
        ...
        sourceCodeButton.addActionListener(ActionListeners.openURL(this, "https://deadmangamers.com/"));
    }
